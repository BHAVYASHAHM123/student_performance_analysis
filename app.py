...
school = st.selectbox(
    'school (0) ----> Mousinho da Silveira and (1) ----> Gabriel Pereira',
    ('school', '0', '1'))
...
Address = st.selectbox(
    'Address  (1) ----> Uraban and (0) ----> Rural',
    ('Address','0', '1'))

 

Family_Size = st.selectbox(
    'Family Size   (1) -----> Less or equal to 3 , (0) -----> Greater than 3 ',
    ('Family Size','1', '0'))

 
Parents_Status = st.selectbox(
    'Parents Status  (0) -----> Apart, (1) -----> Together ',
    ('Parents Status','0', '1'))

 
Mother_Education = st.selectbox(
    'Mother Education  (1) -----> primary edu (4th grade) , (2) ----->  5th to 9th grade , (3) ----> secondary edu , (4)  ----> higher edu ',
    ('Mother Education', '1', '2', '3', '4'))

 
Father_Education = st.selectbox(
    'Father Education (1) ----> primary edu (4th grade) ,(2) ---->  5th to 9th grade , (3) -----> secondary edu , (4) ------>  higher edu ',
...
Travel_Time_from_home_to_College = st.selectbox(
    'Travel Time from home to College  (1) : Less then 15 min., (2) : 15 to 30 min., (3) : 30 min. to 1 hour, or (4) : More then 1 hour',
    ('Travel Time from home to College','1', '2', '3', '4'))

 

Study_Time = st.selectbox(
    'Study Time ( (1) : Less then 2 hours, (2) : 2 to 5 hours, (3) : 5 to 10 hours, or (4) :  More then 10 hours)',
    ('Study Time','1', '2', '3', '4'))
